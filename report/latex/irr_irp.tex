...
\abstract{ This dissertation is concerned with creating agents capable of playing the partially observable board game Cluedo. We implemented a simulator that allows play between these agents and human players. This work is inspired by two recent methods for tractable learning in large partially observable markov decision processes where we reason about our belief of the current game state rather than a fully observable state. We also analyze the strength of our main agent against a baseline.}
